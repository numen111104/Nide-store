                    ...
                    <div className="col-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header">
                                <span className="font-weight-bold"><i className="fa fa-shopping-cart"></i> Transaksi</span>
                            </div>
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td className="text-center">
                                                        {transaction.status == 'UNPAID' &&
                                                            <button className="btn btn-sm btn-warning"><i className="fa fa-circle-notch fa-spin"></i> Berlangsung</button>
                                                        }
                                                        {transaction.status == 'PAID' &&
                                                            <button className="btn btn-sm btn-success"><i className="fa fa-check-circle"></i> Berhasil</button>
                                                        }
                                                        {transaction.status == 'CANCELLED' &&
                                                            <button className="btn btn-sm btn-danger"><i className="fa fa-times"></i> Batal</button>
                                                        }
                                                    </td>
