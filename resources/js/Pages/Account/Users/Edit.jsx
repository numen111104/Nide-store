...
export default function UserEdit() {
    ...
    return (
        <>
            <Head>
                <title>Edit Users - Nide Store</title>
            </Head>
            <LayoutAccount>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <div className="mb-3">
                                                ...
                                                <input type="password" className="form-control" value={passwordConfirmation} onChange={(e) => setPasswordConfirmation(e.target.value)} placeholder="Ulangi Password" />
                                            </div>
                                        </div>
                                    </div>
